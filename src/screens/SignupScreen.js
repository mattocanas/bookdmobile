...
const Signup = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.greeting}>Register for book'd!</Text>
      ...
      <View style={styles.form}>
        ...
        <View style={{marginTop: 32}}>
          <Text style={styles.inputTitle}>School or Company</Text>
          <TextInput
            onChangeText={(newSchool) => setSchool(newSchool)}
            value={school}
            style={styles.input}
            autoCapitalize="none"
            autoCorrect={false}
            placeholder="i.e. UT Austin (Hook em' 🤘) "
      ...
      <TouchableOpacity
        ...
        <Text style={{color: '#c1c8d4', fontSize: 13}}>
          ...
          <Text style={{color: '#55d077', fontWeight: '500'}}>Sign in!</Text>
        </Text>
      </TouchableOpacity>
    </View>
  );
